...
<body>
    <header>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="#tickt"><i class="fa fa-fw fa-ticket"></i> Tickets</a>
                <a href="#con"><i class="fa fa-fw fa-info-circle"></i> About us</a>
                <a href="loginindex.php"><i class="fa fa-fw fa-user"></i> Log In</a>
            </div>
         </div>
    </header>
	...
	<div class="center">
			<a href="loginIndex.php" class="ticket-btn">Login to buy the ticket</a>
	</div>
